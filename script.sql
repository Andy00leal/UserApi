-- Database: prueba_coink

DROP DATABASE IF EXISTS prueba_coink;

CREATE DATABASE prueba_coink
    WITH
    OWNER = postgres
    ENCODING = 'UTF8'
...
('Tanzania'),
('Tayikistán'),
('Territorio Británico del Océa'),
('Tierras Australes y Antártica'),
('Timor Oriental'),
('Togo'),
('Tokelau'),
('Tonga'),
...
(
    ...
    CONSTRAINT fk_department_country FOREIGN KEY ("Id_country")
        REFERENCES public."Countries" ("Id") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);

INSERT INTO Departments (id, id_country, name)
VALUES
	(5, 47,'ANTIOQUIA'),
	(8, 47,'ATLÁNTICO'),
	(11, 47,'BOGOTÁ, D.C.'),
	...
	(50, 47,'META'),
	(52, 47,'NARIÑO'),
	(54, 47,'NORTE DE SANTANDER'),
	(63, 47,'QUINDIO'),
	(66, 47,'RISARALDA'),
	(68, 47,'SANTANDER'),
	(70, 47,'SUCRE'),
	(73, 47,'TOLIMA'),
	(76, 47,'VALLE DEL CAUCA'),
	(81, 47,'ARAUCA'),
	(85, 47,'CASANARE'),
	(86, 47,'PUTUMAYO'),
	(88, 47,'ARCHIPIÉLAGO DE SAN ANDRÉS, PROVIDENCIA Y SANTA CATALINA'),
	(91, 47,'AMAZONAS'),
	(94, 47,'GUAINÍA'),
	(95, 47,'GUAVIARE'),
	(97, 47,'VAUPÉS'),
...
(
    "Id" integer NOT NULL DEFAULT nextval('municipality_id_seq'::regclass),
    "Name" character varying COLLATE pg_catalog."default" NOT NULL,
    "State" integer NOT NULL DEFAULT 1,
    "Id_department" integer NOT NULL,
    CONSTRAINT pk_id_municipality PRIMARY KEY ("Id"),
    CONSTRAINT fk_municipality_department FOREIGN KEY ("Id_department")
        REFERENCES public."Departments" ("Id") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);

INSERT INTO Municipalities (id, name, state, id_department)
VALUES
	(1,'Abriaquí',1,5),
	(2,'Acacías',1,50),
	(3,'Acandí',1,27),
...
(
    ...
    CONSTRAINT fk_user_country FOREIGN KEY ("Id_country")
        REFERENCES public."Countries" ("Id") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fk_user_department FOREIGN KEY ("Id_department")
        REFERENCES public."Departments" ("Id") MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fk_user_minicipality FOREIGN KEY ("Id_municipality")
